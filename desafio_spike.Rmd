...
El siguiente paso sería corregir los precios nominales de la leche, por precios reales, de modo que sea posible comparar
...
Después podemos revisar la correlación cruzada entre otras variables y así no incluir variables de muy alta correlación con las que ya fueron incluidas.

```{r}
corr_cross(cor_matrix, max_pvalue = 0.05,top = 30)
```

Un ejemplo claro de variables correlacionadas son las temporales, los trimestres siempre están asociados a los mismos meses, por lo que incluir ambas como predictores probablemente no va a ser mejor que incluir solo una.
